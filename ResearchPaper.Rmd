...
stargazer::stargazer(violent_probit2, property_probit2, money_probit2, covariate.labels = labels2,
    title = 'Logistic Regression Estimates of Model 2.1 to 2.3',
    digits = 2, type = 'html')
...
```{r Map Prostitution & Gambling crime, echo=FALSE}
## Clustered crimes 
...
## we want to add location of police station, district borders and our cirlce to this map
```
...
stargazer::stargazer(Prostitution_probit3, Narcotics_probit3, Gambling_probit3, Arson_probit3, covariate.labels = labels3,
    title = 'Logistic Regression Estimates of Model 3.1 to 3.4',
    digits = 2, type = 'html')
...
## Linear Model with Absolute Distances 

absoluteDist <- lm(distance_sta ~ as.integer(hardship_index) + as.factor(property), data=Crime_Data )
summary(absoluteDist)

absoluteDist <- lm(distance_sta ~ as.integer(hardship_index) + as.factor(Prostitution), data=Crime_Data )
summary(absoluteDist)

absoluteDist <- lm(distance_sta ~ as.integer(hardship_index) + as.factor(Gambling), data=Crime_Data )
summary(absoluteDist)
