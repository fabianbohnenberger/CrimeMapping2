...
```{r CCalculating district centers, echo=FALSE}
...
**Map 1** shows a plot with the map of Chicago. It is divided into Police Districts, the centroids of every district are presented in circles. The locations of all the police stations is presented in triangles. 
...
```{r Map Most Common Crimes, echo=FALSE, warnings = FALSE, error=FALSE}
...
```{r Map Violations, echo=FALSE, warnings = FALSE, error=FALSE}
...
```{r Map Clustered Crimes, echo=FALSE, warnings = FALSE, error=FALSE}
...
```{r Map Specific Felonies, echo=FALSE, warnings = FALSE, error=FALSE}
...
Figure 5 and Figure 6 show the same distributions as Figure 3 and Figure 4, but use the distance to the Police Station as the center point. 
